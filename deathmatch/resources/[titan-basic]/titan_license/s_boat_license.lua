...
function giveBoatLicense(usingGC)
	...
	exports.titan_hud:sendBottomNotification(source, "Department of Motor Vehicles", "Congratulations! You are now fully licensed captain a boat on the water." )
	exports.titan_global:giveItem(source, 155, getPlayerName(source):gsub("_"," "))
