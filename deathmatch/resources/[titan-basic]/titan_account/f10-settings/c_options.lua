...
--  triggerEvent( 'hud:blur', resourceRoot, 6, false, 0.5, nil )
	...
	if getResourceFromName("titan_admins") and exports['titan_admins']:canPlayerAccessStaffManager(localPlayer) then
	...
	if getResourceFromName("titan_factions") and exports.titan_factions:canAccessFactionManager( localPlayer ) then
	...
	if getResourceFromName("titan_interior_system") and getResourceFromName("titan_interiormanager") and exports.titan_integration:isPlayerAdmin( localPlayer ) then
	...
	if getResourceFromName('titan_vehicle') and getResourceFromName("titan_vehicle_manager") then
	...
	exports.titan_global:centerWindow(wOptions)
end
...
function overlayDescSettings(button, state)
	if source == bOverlayDescription then
		if wOverlayDescSettings then
			...
			guiCreateStaticImage ( 10, 25+y+23, windowWidth-20 , 1, ":titan_admins/images/whitedot.jpg", false, wOverlayDescSettings )
			y = y + 30
			...
			guiCreateStaticImage ( 10, 25+y+21, windowWidth-20 , 1, ":titan_admins/images/whitedot.jpg", false, wOverlayDescSettings )
