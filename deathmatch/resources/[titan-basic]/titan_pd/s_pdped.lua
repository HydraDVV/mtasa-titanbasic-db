...
function pdPedStart(pedName)
	exports['titan_global']:sendLocalText(client, "Joe McDonald says: Hello, how can I help you?", 255, 255, 255, 10)
end
addEventHandler("pd:ped:start", getRootElement(), pdPedStart)

addEvent("pd:ped:help", true)
function pdPedHelp(pedName)
	exports['titan_global']:sendLocalText(client,"Joe McDonald says: Alright, I'll notify any available units now, please wait patiently.", 255, 255, 255, 10)
...
function pdPedAppointment(pedName)
	exports['titan_global']:sendLocalText(client, "Joe McDonald says: I'll notify any available Officers now, please take a seat.", 255, 255, 255, 10)
	for key, value in ipairs( getPlayersInTeam( getTeamFromName("Los Santos Police Department") ) ) do
