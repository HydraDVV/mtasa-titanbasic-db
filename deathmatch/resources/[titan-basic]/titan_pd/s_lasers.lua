function toggleLaser(thePlayer)
	...
	if not (laser) then
		exports.titan_anticheat:changeProtectedElementDataEx(thePlayer, "laser", true, true)
		outputChatBox("Your weapon laser is now ON.",thePlayer, 0, 255, 0)
	else
		exports.titan_anticheat:changeProtectedElementDataEx(thePlayer, "laser", false, true)
