...
function konus (element)
	...
	elseif (ped=="Galerici Rıfat") then
	...
	elseif (ped=="Julie Dupont") then 
		...
		exports.titan_hud:sendBottomNotification(getLocalPlayer(),(ped or "NPC").." diyor ki:", "'Sana yardımcı olabileceğim bir konu yok, üzgünüm.'")
	end
end
