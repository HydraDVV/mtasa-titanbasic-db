...
local notificationFont = exports.titan_fonts:getFont("Roboto", 14)
local notificationFontBold = exports.titan_fonts:getFont("AwesomeFont", 15)
...
function getColors(render)
    ...
    if enabled then
        engine = exports['titan_coloration']
        types = {
