...
function PrisonGUIF(result)
        ...
        PrisonGUI.window[1] = guiCreateWindow(x, y, w, h, "IC Jail Sistemi", false)
        ...
        if pd_offline_jail or exports.titan_integration:isPlayerTrialAdmin(getLocalPlayer()) then
...
function prisonPed()
    local ped = createPed(283, 1573.638671875, -1671.9482421875, 12.1796875)
    setPedAnimation(ped, "COP_AMBIENT", "Coplook_loop", -1, true, false, false)
    setElementFrozen(ped, true)
    setElementRotation(ped, 0, 0, 0)
