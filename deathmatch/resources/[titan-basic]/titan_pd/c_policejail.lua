...
exports.titan_global:applyAnimation( Fitz, "FOOD", "FF_Sit_Look", -1, true, false, true)
...
function doTimer(thePed)
	...
	exports.titan_global:applyAnimation( thePed, "FOOD", "FF_Sit_Look", -1, true, false, true)
