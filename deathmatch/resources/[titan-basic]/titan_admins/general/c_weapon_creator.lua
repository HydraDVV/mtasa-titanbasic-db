...
local adminTitle = exports.titan_global:getPlayerAdminTitle(getLocalPlayer())
...
function openWeaponCreatorMain(commandName, category)
	if exports.titan_integration:isPlayerSeniorAdmin(localPlayer) then
		...
		wWeaponsMain = guiCreateWindow(wWeaponsMain_x,wWeaponsMain_y,560,230,"Silah Oluşturma Paneli - Basit Arayüz",false)
			...
			lCredit1 = guiCreateLabel(10,28,300,18,"Yetkili Silah Olutuşturma Arayüzü - Hanz",false,wWeaponsMain)
			...
			lCredit2 = guiCreateLabel(240,28,300,18,"© Hanz",false,wWeaponsMain)
