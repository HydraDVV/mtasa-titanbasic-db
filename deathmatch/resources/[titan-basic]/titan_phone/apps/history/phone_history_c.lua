...
function analyzeHistory(his)
	...
	--outputChatBox("exports.titan_ed_datetime:formatTimeInterval( datesec ) - "..exports.titan_ed_datetime:formatTimeInterval( datesec ))
	return history_name, history_number, exports.titan_datetime:formatTimeInterval( datesec ), flow, private
end
