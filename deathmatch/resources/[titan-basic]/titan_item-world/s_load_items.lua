			...
			if rows > 0 then
				for index, row in ipairs(res) do
					...
					if itemID < 0 then -- weapon
						...
						exports.titan_anticheat:changeProtectedElementDataEx(obj, "creator", creator)
						exports.titan_anticheat:changeProtectedElementDataEx(obj, "createdDate", createdDate)
						
						if protected and protected ~= 0 then
							exports.titan_anticheat:changeProtectedElementDataEx(obj, "protected", protected)
						end
					else
						...
						if isElement(obj) then
							exports.titan_pool:allocateElement(obj, itemID, true)
							setElementDimension(obj, dimension)
							setElementInterior(obj, interior)
							exports.titan_anticheat:changeProtectedElementDataEx(obj, "creator", creator)
							exports.titan_anticheat:changeProtectedElementDataEx(obj, "createdDate", createdDate)
...
function loadWorldItems(res)
	...
	dbExec(exports.titan_mysql:getConnection(), "DELETE FROM `worlditems` WHERE `protected`='0' AND `itemID` NOT IN(81, 103, 169) AND ( (DATEDIFF(NOW(), creationdate) > 30 ) OR (DATEDIFF(NOW(), creationdate) > 7 AND `itemID` = 72) ) " )
