...
function drawTooltip(type, text, spec)
    ...
    if type == 1 then
        ...
        --local text = "Asd"
        local cx, cy = exports['titan_core']:getCursorPosition()
    ...
    elseif type == 2 then
        local font3 = exports['titan_fonts']:getFont("Rubik-Regular", 10)
        ...
        local alpha = 255
        local size = 1
        local startX, startY = exports['titan_core']:getCursorPosition()
        if spec then
