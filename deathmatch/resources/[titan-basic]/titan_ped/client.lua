...
function adminEditPedGui(element)
	if exports.titan_integration:isPlayerHeadAdmin(localPlayer) or exports.titan_integration:isPlayerScripter(localPlayer) then
...
function canPlayerUseLevel(level)
	if level == 0 then
		return true
	elseif level == 1 then
		return exports.titan_integration:isPlayerTrialAdmin(localPlayer) or exports.titan_integration:isPlayerScripter(localPlayer)
	elseif level == 2 then
		return exports.titan_integration:isPlayerAdmin(localPlayer) or exports.titan_integration:isPlayerScripter(localPlayer)
	elseif level == 3 then
		return exports.titan_integration:isPlayerSeniorAdmin(localPlayer) or exports.titan_integration:isPlayerScripter(localPlayer)
	elseif level == 4 then
		return exports.titan_integration:isPlayerLeadAdmin(localPlayer) or exports.titan_integration:isPlayerScripter(localPlayer)
	elseif level == 5 then
		return exports.titan_integration:isPlayerScripter(localPlayer)
	end
	return false
end
