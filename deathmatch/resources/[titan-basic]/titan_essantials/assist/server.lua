...
function removeBackup(thePlayer, commandName)
	if (exports.titan_integration:isPlayerTrialAdmin(thePlayer)) or (getElementData(getPlayerTeam(thePlayer), "type") == 4 and getElementData(thePlayer, "factionleader") == 1) then
