function getNearbyObjects(commandName)
	if exports.titan_integration:isPlayerAdmin(getLocalPlayer()) then
		outputChatBox("Nearby worldobjects:", 255, 126, 0)
		local count = 0
		
		for index, nearbyObject in ipairs( exports.titan_global:getNearbyElements(getLocalPlayer(), "object") ) do
