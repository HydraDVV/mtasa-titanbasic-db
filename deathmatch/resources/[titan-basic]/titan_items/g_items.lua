g_items = {
	...
	[128] = { "Modifiyeci", "#v", 10, 1581, 270, 270, 0, 0, weight = 0.3 }, --128 -- Hanz | ADD TTR FACTION BAGDE ITEM | 24.1.14
	...
	[169] = { "Keyless Digital Door Lock", "This high-ended security system is much more secure than a traditional keyed lock because they can't be picked or bumped.", 6, 2922, 0, 0, 180, 0.2, weight = 0.5 }, -- Hanz
	...
	[215] = { "Akustik Gitar", "Takamine marka akustik gitar.", 4, 1901, 0, 180, 360, 0.06, weight = 0.1}, -- Hanz
	[227] = { "Nargile", "Seri köz getir kardeşim.", 1, 1902, 0, 0, 0, 0.3, weight = 2, hideItemValue = true }, -- Hanz
	[228] = { "Fotoğraf", "Bir adet fotoğraf.", 1, 1271, 0, 0, 0, 0, weight = 0.1, hideItemValue = true }, -- Hanz
	[229] = { "Tuborg Bira", "Adam gibi bira - Tuborg.", 1, 1520, 0, 0, 0, 0, weight = 1, }, -- Hanz
	[230] = { "Yeni Rakı", "Yeni rakı.", 1, 1520, 0, 0, 0, 0, weight = 1, }, -- Hanz
	...
	[248] = { "Bilardo Masası", "Tek kullanımlıktır, sadece interior içerisine kurulabilir.", 1, 1581, 0, 0, 0, 0, weight = 0.5 }, -- Hanz
	[249] = { "Araç Ruhsatı", "Bir adet araç tescil belgesi.", 1, 1581, 0, 0, 0, 0, weight = 0.5 }, -- Hanz
	
	[250] = { "Balık Yemi", "#v adet balık yemi.", 1, 1271, 0, 0, 0, 0, weight = 1 }, -- Hanz
	
	[251] = { "Simit", "Bir adet gevrek simit.", 1, 1925, 0, 0, 0, 0, weight = 0.25 }, -- Hanz
	[252] = { "Açma", "Bir adet yumuşak açma.", 1, 1925, 0, 0, 0, 0, weight = 0.25 }, -- Hanz
	...
	[287] = { "Ağ", "Denizde atabileceğin bir ağ.", 6, 1914, 0, 0, 0, 0.285, weight = 0.5 },
	[288] = { "Gerilmiş Ağ", "Gerilmiş bir ağ..", 1, 2215, 205, 205, 0, 0.01, weight = 0.1 },
	...
	[515] = { "Tamirci Kartı", "Tamirci Kartı", 10, 1581, 270, 270, 0, 0, weight = 0.1 }, -- Hanz babe
	...
	[560] = { "Çeyrek Altın", "Döviz bürosunda bozdurabileceğiniz Çeyrek Altın.", 4, 2386, 0, 0, 0, 0.285, weight = 0.1 }, --Hanz
    [561] = { "Cumhuriyet Altın", "Döviz bürosunda bozdurabileceğiniz Cumhuriyet Altın.", 4, 2386, 0, 0, 0, 0.285, weight = 0.1 }, --Hanz
    [562] = { "Altın Bilezik", "Döviz bürosunda bozdurabileceğiniz Altın Bilezik.", 4, 2386, 0, 0, 0, 0.285, weight = 0.1 }, --Hanz
    [563] = { "Kazı Kazan", "Kazı ve Kazan!", 4, 2386, 0, 0, 0, 0.285, weight = 0.1 }, --Hanz
    [568] = { "İşlenmemiş Taş", "Fabrikada işleyebileceğiniz bir taş parçası.", 4, 2386, 0, 0, 0, 0.285, weight = 0.1 }, --Hanz
    [569] = { "İşlenmemiş Kömür", "Fabrikada işleyebileceğiniz bir kömür parçası.", 4, 2386, 0, 0, 0, 0.285, weight = 0.1 }, --Hanz
    [570] = { "İşlenmemiş Bakır", "Fabrikada işleyebileceğiniz bir bakır parçası.", 4, 2386, 0, 0, 0, 0.285, weight = 0.1 }, --Hanz
    [571] = { "İşlenmemiş Demir", "Fabrikada işleyebileceğiniz bir demir parçası.", 4, 2386, 0, 0, 0, 0.285, weight = 0.1 }, --Hanz
    [572] = { "İşlenmemiş Altın", "Fabrikada işleyebileceğiniz bir altın parçası.", 4, 2386, 0, 0, 0, 0.285, weight = 0.1 }, --Hanz
    [573] = { "İşlenmiş Taş", "Borsa bürosunda bozdurabileceğiniz işlenmiş bir taş.", 4, 2386, 0, 0, 0, 0.285, weight = 0.1 }, --Hanz
    [574] = { "İşlenmiş Kömür", "Borsa bürosunda bozdurabileceğiniz işlenmiş bir kömür.", 4, 2386, 0, 0, 0, 0.285, weight = 0.1 }, --Hanz
    [575] = { "İşlenmiş Bakır", "Borsa bürosunda bozdurabileceğiniz işlenmiş bir bakır.", 4, 2386, 0, 0, 0, 0.285, weight = 0.1 }, --Hanz
    [576] = { "İşlenmiş Demir", "Borsa bürosunda bozdurabileceğiniz işlenmiş bir demir.", 4, 2386, 0, 0, 0, 0.285, weight = 0.1 }, --Hanz
    [577] = { "İşlenmiş Altın", "Borsa bürosunda bozdurabileceğiniz işlenmiş bir altın.", 4, 2386, 0, 0, 0, 0.285, weight = 0.1 }, --Hanz	
    [578] = { "Kazma", "Kazı yaparken kullanabileceğiniz bir eşya.", 4, 2386, 0, 0, 0, 0.285, weight = 0.1 }, --Hanz	
	[579] = { "Barbekü", "( /barbekukur - /barbekukaldir - /fastfood ).", 4, 2386, 0, 0, 0, 0.285, weight = 0.1 }, --Hanz
	...
	[582] = { "Silah Kasası", "Üzerine tıklayarak gelen şansı değerlendirebilirsin.", 4, 2386, 0, 0, 0, 0.285, weight = 0.1 }, --Hanz
	[583] = { "Premium Silah Kasası", "Üzerine tıklayarak gelen şansı değerlendirebilirsin.", 4, 2386, 0, 0, 0, 0.285, weight = 0.1 }, --Hanz
	[584] = { "Levye", "Kutuları açmanı sağlayacak bir levye.", 4, 2386, 0, 0, 0, 0.285, weight = 0.1 }, --Hanz
	[585] = { "Kokain Tohumu", "Kokain ekmenizi sağlayacak bir tohum.", 4, 2386, 0, 0, 0, 0.285, weight = 0.1 }, --Hanz
	[586] = { "Marijuana Tohumu", "Marijuana ekmenizi sağlayacak bir tohum.", 4, 2386, 0, 0, 0, 0.285, weight = 0.1 }, --Hanz
	[587] = { "Eroin Tohumu", "Eroin ekmenizi sağlayacak bir tohum.", 4, 2386, 0, 0, 0, 0.285, weight = 0.1 }, --Hanz
	[588] = { "Bant", "Ağıza yapıştırılabilecek bir bant.", 4, 2386, 0, 0, 0, 0.285, weight = 0.1 }, --Hanz
	[589] = { "Tütün", "Sigara sarmanızda işinize yarıyacak bir madde..", 4, 2386, 0, 0, 0, 0.285, weight = 0.1 }, --Hanz
	[590] = { "Kaçak Sigara Paketi", "Gizli bir firmaya satabileceğiniz kaçak bir sigara paketi.", 4, 2386, 0, 0, 0, 0.285, weight = 0.1 }, --Hanz
	[591] = { "Pizza", "Mikrodalgadan yeni çıkmış, leziz bir pizza.", 4, 2386, 0, 0, 0, 0.285, weight = 0.1 }, --Hanz
	[592] = { "Piliç", "Mikrodalgadan yeni çıkmış, leziz bir piliç.", 4, 2386, 0, 0, 0, 0.285, weight = 0.1 }, --Hanz
	[593] = { "Omlet", "Mikrodalgadan yeni çıkmış, leziz bir omlet.", 4, 2386, 0, 0, 0, 0.285, weight = 0.1 }, --Hanz
...
function getBadges( )
	return {
		...
		[64]  = { "LSPD Rozet", 		"a LSPD Rozet",			{[1] = true},				 	{0,100,255, true},	2},
		[112]  = { "Poh Rozet", 		"Poh Rozet",			{[376] = true},				 	{58, 171, 1, true},	2}, -- Sheriff department
		[65]  = { "LSCSD badge", 		"a LSCSD badge", {[23] = true},	    {36, 120, 43},	1},
		[86]  = { "LSN badge",		"an LSN ID",				{[20] = true},					{150,150,255},	1},
		[450]  = { "Adalet rozet",		"adalet",				{[339] = true},					{255,51,0},	1},
		[87]  = { "GOV badge",		"a Government badge",		{[3] = true},					{0, 80, 0},	1},
		[65]  = { "LSMD badge",		"a Government badge",		{[2] = true},					{190,0,0},	1},
		...
		[82] = { "Modifiyeci Kartı", "-",	{[4] = true},	{0,255,0},	1}, -- Hanz | ADD TTR FACTION BAGDE ITEM | 24.1.14
