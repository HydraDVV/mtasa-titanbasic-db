		...
		if not (...) then
			...
			if theTeam then
				if dbExec(mysql:getConnection(),"INSERT INTO factions SET name='" .. (factionName) .. "', bankbalance='0', type='" .. (factionType) .. "'") then
					...
					exports.titan_logs:dbLog(thePlayer, 4, theTeam, "MAKE FACTION")
...
function adminRenameFaction(thePlayer, commandName, factionID, ...)
	if (exports.titan_integration:isPlayerLeadAdmin(thePlayer)) or exports.titan_integration:isPlayerBirlikTeamLeader(thePlayer) then
		if not (factionID) or not (...)  then
			...
			if factionID and factionID > 0 then
				...
				if (theTeam) then
					...
					exports.titan_global:sendMessageToAdmins(exports.titan_global:getPlayerFullIdentity(thePlayer).." renamed faction '" .. oldName .. "' to '" .. factionName .. "'.")
					--exports.titan_factions:sendNotiToAllFactionMembers(factionID, "Your faction '"..oldName.."' was renamed to '"..factionName.."' by "..exports.titan_global:getPlayerFullIdentity(thePlayer,1,true))
				else
...
function adminSetPlayerFaction(thePlayer, commandName, partialNick, factionID)
	if exports.titan_integration:isPlayerSeniorAdmin(thePlayer) then
		...
		if not (partialNick) or not (factionID) then
			...
			local targetPlayer, targetPlayerNick = exports.titan_global:findPlayerByPartialNick(thePlayer, partialNick)
			...
			if targetPlayer then
				...
				if dbExec(mysql:getConnection(),"UPDATE characters SET faction_leader = 0, faction_id = " .. factionID .. ", faction_rank = 1, faction_phone = NULL, duty = 0 WHERE id=" .. getElementData(targetPlayer, "dbid")) then
					...
					if factionID > 0 then
						exports.titan_anticheat:changeProtectedElementDataEx(targetPlayer, "faction", factionID, true)
						exports.titan_anticheat:changeProtectedElementDataEx(targetPlayer, "factionrank", 1, true)
						exports.titan_anticheat:changeProtectedElementDataEx(targetPlayer, "factionphone", nil, true)
						--triggerClientEvent(targetPlayer, "updateFactionInfo", targetPlayer, factionID, 1)
						exports.titan_anticheat:changeProtectedElementDataEx(targetPlayer, "factionleader", 0, true)
						...
						exports.titan_logs:dbLog(thePlayer, 4, { targetPlayer, theTeam }, "SET TO FACTION")
					else
						-- Citizen bug fix by Anthony
						local citizenTeam = getTeamFromName("Citizen")
						setPlayerTeam(targetPlayer, citizenTeam)
						exports.titan_anticheat:changeProtectedElementDataEx(targetPlayer, "faction", -1, true)
						exports.titan_anticheat:changeProtectedElementDataEx(targetPlayer, "factionrank", 1, true)
						exports.titan_anticheat:changeProtectedElementDataEx(targetPlayer, "factionphone", nil, true)
						exports.titan_anticheat:changeProtectedElementDataEx(targetPlayer, "factionleader", 0, true)
						...
						if getElementData(targetPlayer, "duty") and getElementData(targetPlayer, "duty") > 0 then
							...
							exports.titan_anticheat:changeProtectedElementDataEx(targetPlayer, "duty", 0, true)
						end
						...
						exports.titan_logs:dbLog(thePlayer, 4, { targetPlayer }, "REMOVE FROM FACTION")
					end
				end
			end
		end
		...
		elseif factionID > 0 then
			...
			if targetPlayer then
				...
				if dbExec(mysql:getConnection(),"UPDATE characters SET faction_leader = 1, faction_id = " .. tonumber(factionID) .. ", faction_rank = 1, faction_phone = NULL, duty = 0 WHERE id = " .. getElementData(targetPlayer, "dbid")) then
					...
					exports.titan_anticheat:changeProtectedElementDataEx(targetPlayer, "faction", factionID, true)
					exports.titan_anticheat:changeProtectedElementDataEx(targetPlayer, "factionrank", 1, true)
					exports.titan_anticheat:changeProtectedElementDataEx(targetPlayer, "factionleader", 1, true)
					exports.titan_anticheat:changeProtectedElementDataEx(targetPlayer, "factionphone", nil, true)
					--triggerClientEvent(targetPlayer, "updateFactionInfo", targetPlayer, factionID, 1)
					triggerEvent("duty:offduty", targetPlayer)
					
					outputChatBox("#822828"..exports["titan_pool"]:getServerName()..": #f4f4f4Oyuncu " .. targetPlayerNick .. " isimli birlik lideri sizi birliğine ekledi '" .. getTeamName(theTeam) .. "' (#" .. factionID .. ").", thePlayer, 0, 255, 0, true)
						
					triggerEvent("onPlayerJoinFaction", targetPlayer, theTeam)
					outputChatBox("#822828"..exports["titan_pool"]:getServerName()..": #f4f4f4İhtilaf liderine atandın '" .. getTeamName(theTeam) .. "'.", targetPlayer, 255, 194, 14, true)
					
					exports.titan_logs:dbLog(thePlayer, 4, { targetPlayer, theTeam }, "SET TO FACTION LEADER")
					--exports.titan_factions:sendNotiToAllFactionMembers(factionID, targetPlayerNick .. " is now a leader of your faction '" .. getTeamName(theTeam) .. "'!", "Set by "..exports.titan_global:getPlayerFullIdentity(thePlayer))
				else
					outputChatBox("#822828"..exports["titan_pool"]:getServerName()..": #f4f4f4Geçersiz İhtilaf Kimliği.", thePlayer, 255, 0, 0, true)
				end
			end
		end
	end
		...
		elseif factionRank >= 1 and factionRank <= 20 then
			...
			if targetPlayer then
				...
				if dbExec(mysql:getConnection(),"UPDATE characters SET faction_rank = " .. factionRank .. " WHERE id = " .. getElementData(targetPlayer, "dbid")) then
					exports.titan_anticheat:changeProtectedElementDataEx(targetPlayer, "factionrank", factionRank, true)
					...
					exports.titan_logs:dbLog(thePlayer, 4, { targetPlayer, theTeam }, "SET TO FACTION RANK " .. factionRank)
				else
		...
		if not (factionID)  then
			...
			if factionID and factionID > 0 then
				...
				if (theTeam) then
					...
					exports.titan_logs:dbLog(thePlayer, 4, theTeam, "DELETE FACTION")
					--exports.titan_factions:sendNotiToAllFactionMembers(factionID, "Your faction '"..getTeamName( theTeam ).."' was deleted by "..exports.titan_global:getPlayerFullIdentity(thePlayer, 1, true).."!")
					local civTeam = getTeamFromName("Citizen")
					for key, value in pairs( getPlayersInTeam( theTeam ) ) do
						setPlayerTeam( value, civTeam )
						exports.titan_anticheat:changeProtectedElementDataEx( value, "faction", -1, true )
						--triggerClientEvent(targetPlayer, "updateFactionInfo", targetPlayer, -1, 1)
					end
					destroyElement( theTeam )
...
function adminShowFactions(thePlayer)
	if (exports.titan_integration:isPlayerTrialAdmin(thePlayer) or exports.titan_integration:isPlayerSupporter(thePlayer) or exports.titan_integration:isPlayerScripter(thePlayer)) or exports.titan_integration:isPlayerBirlikTeamLeader(thePlayer) then
		dbQuery(
			function(qh)
...
function adminShowFactionOnlinePlayers(thePlayer, commandName, factionID)
	if (exports.titan_integration:isPlayerTrialAdmin(thePlayer) or exports.titan_integration:isPlayerSupporter(thePlayer)) or exports.titan_integration:isPlayerBirlikTeamLeader(thePlayer) then
		if not (factionID)  then
			outputChatBox("KULLANIM: /" .. commandName .. " [Faction ID]", thePlayer, 255, 194, 14)
		else
			factionID = tonumber(factionID)
...
addEventHandler('faction:admin:showf3', root,
	function(id, fromF3)
		if exports.titan_integration:isPlayerTrialAdmin(client) --[[or exports.titan_integration:isPlayerSupporter(client)]] then
	...
	if (exports.titan_integration:isPlayerLeadAdmin(thePlayer)) then
		if not (factionID) or not (amount)  then
			...
			if factionID and factionID > 0 then
				...
				if (theTeam) then
					if exports.titan_global:setMoney(theTeam, amount) then
						outputChatBox("Set faction '" .. getTeamName(theTeam) .. "'s money to " .. amount .. " $.", thePlayer, 255, 194, 14)
					--	exports.titan_factions:sendNotiToAllFactionMembers(factionID, exports.titan_global:getPlayerFullIdentity(thePlayer, 1).." has set your faction bank to $"..exports.titan_global:formatMoney(amount)..".", nil, true)
					else
...
function getTax(thePlayer)
	loadWelfare( )
	outputChatBox( "Welfare: $" .. exports.titan_global:formatMoney(unemployedPay), thePlayer, 255, 194, 14 )
	outputChatBox( "Tax: " .. ( exports.titan_global:getTaxAmount(thePlayer) * 100 ) .. "%", thePlayer, 255, 194, 14 )
	outputChatBox( "Income Tax: " .. ( exports.titan_global:getIncomeTaxAmount(thePlayer) * 100 ) .. "%", thePlayer, 255, 194, 14 )
end
			...
			if factionID and factionID > 0 then
				...
				if (theTeam) then
					if getElementData(theTeam, "type") >= 2 and getElementData(theTeam, "type") <= 6 then
						if exports.titan_global:takeMoney(getPlayerTeam(thePlayer), amount) then
							exports.titan_global:giveMoney(theTeam, amount)
							outputChatBox("You added $" .. exports.titan_global:formatMoney(amount) .. " to the budget of '" .. getTeamName(theTeam) .. "' (Total: " .. exports.titan_global:getMoney(theTeam) .. ").", thePlayer, 255, 194, 14)
...
function setTax(thePlayer, commandName, amount)
	if getPlayerTeam(thePlayer) == getTeamFromName("Los Santos Government") and getElementData(thePlayer, "factionrank") >= 15 then
		...
		if not amount or amount < 0 or amount > 30 then
			...
			exports.titan_global:setTaxAmount(amount)
...
function setIncomeTax(thePlayer, commandName, amount)
	if getPlayerTeam(thePlayer) == getTeamFromName("Los Santos Government") and getElementData(thePlayer, "factionrank") >= 15 then
		...
		if not amount or amount < 0 or amount > 25 then
			...
			exports.titan_global:setIncomeTaxAmount(amount)
...
function setWelfare(thePlayer, commandName, amount)
	if getPlayerTeam(thePlayer) == getTeamFromName("Los Santos Government") and getElementData(thePlayer, "factionrank") >= 15 then
		...
		elseif dbExec(mysql:getConnection(), "UPDATE settings SET value = " .. unemployedPay .. " WHERE name = 'welfare'" ) then
			...
			outputChatBox("New Welfare is $" .. exports.titan_global:formatMoney(unemployedPay) .. "/payday", thePlayer, 0, 255, 0)
		else
...
function issueGovLicense(thePlayer, commandName, type, ...)
	...
	if getPlayerTeam(thePlayer) == getTeamFromName("Los Santos Government") and getElementData(thePlayer, "factionrank") >= 3 then
		...
		if not type or not licenseTypes[type] or not ... then
			...
			local success, error = exports.titan_global:giveItem(thePlayer, 80, text)
			if success then
	...
	if (exports.titan_integration:isPlayerTrialAdmin(thePlayer)) then
		...
		if (factionID) and (factionID > 0) then
			...
			if (theTeam) then
				...
				exports.titan_global:sendMessageToAdmins("AdmCmd: " .. tostring(adminTitle) .. " " .. username .. " respawned all unoccupied faction vehicles for faction ID " .. factionID .. ".")
				exports.titan_logs:dbLog(thePlayer, 4, theTeam, "FACTION RESPAWN for " .. factionID)
			else
	...
	if (exports.titan_integration:isPlayerLeadAdmin(thePlayer) or exports.titan_integration:isPlayerScripter(thePlayer)) then
		if not (factionID) or not (onay)  then
			...
			if factionID and factionID > 0 then
				local theTeam = exports.titan_pool:getElement("team", factionID)
				if (theTeam) then
					dbExec(exports.titan_mysql:getConnection(),"UPDATE factions SET onay='" .. tonumber(onay) .. "' WHERE id='" .. factionID .. "'")
					local oldName = getTeamName(theTeam)
					setElementData(theTeam, "birlik_onay", tonumber(onay))
					
					if tonumber(onay) == 1 then
						exports.titan_global:sendMessageToAdmins(exports.titan_global:getPlayerFullIdentity(thePlayer).." '" .. oldName .. "' isimli birliği onayladı!")
					elseif tonumber(onay) == 0 then
						exports.titan_global:sendMessageToAdmins(exports.titan_global:getPlayerFullIdentity(thePlayer).." '" .. oldName .. "' isimli birliği onayını kaldırdı!")
					end
				else
					outputChatBox("Invalid Faction ID.", thePlayer, 255, 0, 0)
				end
