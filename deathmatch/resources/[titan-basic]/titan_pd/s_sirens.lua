function vehicleBlown()
	exports.titan_anticheat:changeProtectedElementDataEx(source, "lspd:siren", false)
	setVehicleSirensOn ( source , false )
end
addEventHandler("onVehicleRespawn", getRootElement(), vehicleBlown)

function setSirenState()
	if exports.titan_global:hasItem(source, 85) then -- sirens
		local curState = getElementData(source, "lspd:siren")
		exports.titan_anticheat:changeProtectedElementDataEx(source, "lspd:siren", not curState)
