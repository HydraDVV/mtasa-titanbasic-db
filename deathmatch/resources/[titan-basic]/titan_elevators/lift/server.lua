...
function deleteLift(thePlayer, commandName, id)
	if (exports.titan_integration:isPlayerTrialAdmin(thePlayer) or tostring(getElementData(thePlayer, "account:username")) == "Exciter") then
...
function liftOutputMe(text)
	if text then
		exports.titan_global:sendLocalMeAction(client, tostring(text))
	end	
end
