...
Interaction.Panel = function(interactions,durum)
    if interactionActive then
        ...
        dxDrawRectangle(panelX, panelY - 100, panelW, panelH + (rowH * adjustH), tocolor(135, 135, 135, 220))
        ...
        for i = 1, adjustH do
            ...
            if interaction then
	            ...
	            if i % 2 == 0 then 
	                ...
	                dxDrawInteractionButton("interaction:" .. i, interaction[1], rowX, rowY, calculatedRowW, rowH-2, {153,153,153,50}, {90,20,20, 244}, {153,153,153}, fonts.Roboto11, "left", "center", interaction[2], iconW, iconH, {50, 50, 50})
	            else
	               
	                dxDrawInteractionButton("interaction:" .. i, interaction[1], rowX, rowY, calculatedRowW, rowH-2, {153,153,153,80}, {90,20,20, 244}, {153,153,153}, fonts.Roboto11, "left", "center", interaction[2], iconW, iconH, {50, 50, 50})
	            end
	        end
...
addCommandHandler("home",function()
		soundVol = playSound("fx/popup.wav")
