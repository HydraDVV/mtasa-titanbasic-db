...
function newGate(thePlayer, commandName, itemID)
	if exports.titan_integration:isPlayerAdmin(thePlayer) then
		...
		if tempObject then
			...
			exports.titan_anticheat:changeProtectedElementDataEx(tempObject, "gate:parameters", tempTable, false)
			exports.titan_anticheat:changeProtectedElementDataEx(tempObject, "gate:id", -1, false)
			exports.titan_anticheat:changeProtectedElementDataEx(tempObject, "gate:edit", true, false)
			...
			if rows > 0 then
				for index, row in ipairs(res) do
					...
					if tempObject then
						...
						exports.titan_anticheat:changeProtectedElementDataEx(tempObject, "gate:parameters", tempTable, false)
						exports.titan_anticheat:changeProtectedElementDataEx(tempObject, "gate:id", row["id"], true)
						exports.titan_anticheat:changeProtectedElementDataEx(tempObject, "gate:edit", false, false)
						exports.titan_anticheat:changeProtectedElementDataEx(tempObject, "gate:busy", false, false)
						exports.titan_anticheat:changeProtectedElementDataEx(tempObject, "gate", true, true)
						...
						exports.titan_anticheat:changeProtectedElementDataEx(tempObject, "gate:triggerDistance", triggerDistance, true)
						exports.titan_anticheat:changeProtectedElementDataEx(tempObject, "gate:triggerDistanceVehicle", triggerDistanceVehicle, true)
						exports.titan_anticheat:changeProtectedElementDataEx(tempObject, "gate:sound", gateSound, true)
						
						setElementDimension(tempObject, tonumber(row["objectDimension"]))
						setElementInterior(tempObject, tonumber(row["objectInterior"]))
						table.insert(gates, tempObject)
						--exports.titan_pool:allocateElement(tempObject, false, true)
					end
				end
			end
		end,
...
function createGate(model,x,y,z,rx,ry,rz,x2,y2,z2,rx2,ry2,rz2,int,dim,autocloseTime,movementTime,gateType,securityParameters,triggerDistance,triggerDistanceVehicle,sound)
	...
	if tempObject then
		...
		exports.titan_anticheat:changeProtectedElementDataEx(tempObject, "gate:triggerDistance", triggerDistance, true)
		exports.titan_anticheat:changeProtectedElementDataEx(tempObject, "gate:triggerDistanceVehicle", triggerDistanceVehicle, true)
		exports.titan_anticheat:changeProtectedElementDataEx(tempObject, "gate:sound", sound, false)
