...
anticheat = exports.titan_anticheat
items = exports['titan_items']
itemtexture = exports['titan_item-texture']
global = exports.titan_global
integration = exports.titan_integration

function canEditItemProperties(thePlayer, object)
	if not object then return false end
	local interiorID = getElementDimension(object)
	if exports.titan_global:hasItem(localPlayer, 4, interiorID) or exports.titan_global:hasItem(localPlayer, 5, interiorID) or (exports.titan_integration:isPlayerTrialAdmin(thePlayer) and exports.titan_global:isAdminOnDuty(thePlayer)) or exports.titan_integration:isPlayerScripter(thePlayer) then
		return true
	end
	return false
end
