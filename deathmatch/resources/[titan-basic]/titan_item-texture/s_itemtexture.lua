integration = exports.titan_integration -- Don't do stuff like this for too many resources cuz it requires a correct ordering of resources in mtaserver.cnf or else your script fails to work everytime server restarts. Can be annoying and impossible sometimes. / Maxime
global = exports.titan_global
pool = exports.titan_pool
