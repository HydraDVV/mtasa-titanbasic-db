...
local BizNoteFont18 = dxCreateFont ( ":titan_resources/fonts/BizNote.ttf" , 18 )
...
setTimer( 
function ()
	if showExternalReportBox(localPlayer) and exports.titan_hud:isActive() then 
...
--			dxDrawText( "Geliştirici: Hanz" , posX+530, posY, w-5, 5, tocolor ( 255, 255, 255, 70 ), 1)
...
function togAdminPanel()
	if exports.titan_integration:isPlayerTrialAdmin(localPlayer) or exports.titan_integration:isPlayerSupporter(localPlayer) then
