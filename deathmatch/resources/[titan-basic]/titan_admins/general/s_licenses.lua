				...
				elseif (logged==1) then
					...
					if getElementData(targetPlayer, "license."..licenseType) == 1 then
						...
						if (licenseType == "car") then -- DRIVERS LICENSE
							exports.titan_anticheat:changeProtectedElementDataEx(targetPlayer, "license."..licenseType, 1, false)
							...
							exports.titan_logs:dbLog(thePlayer, 4, targetPlayer, "GIVELICENSE CAR")
							local hiddenAdmin = getElementData(thePlayer, "hiddenadmin")

							if (hiddenAdmin==0) then
								local adminTitle = exports.titan_global:getPlayerAdminTitle(thePlayer)
								exports.titan_global:sendMessageToAdmins("AdmCmd: " .. tostring(adminTitle) .. " " .. getPlayerName(thePlayer) .. " gave " .. targetPlayerName .. " a drivers license.")
							else
						...
						elseif (licenseType == "bike") then -- BIKE LICENSE
							...
							outputChatBox("Admin "..getPlayerName(thePlayer):gsub("_"," ").." gives you a "..licenseTypeOutput.." license.", targetPlayer, 0, 255, 0)
							exports.titan_logs:dbLog(thePlayer, 4, targetPlayer, "GIVELICENSE BIKE")
							local hiddenAdmin = getElementData(thePlayer, "hiddenadmin")

							if (hiddenAdmin==0) then
								local adminTitle = exports.titan_global:getPlayerAdminTitle(thePlayer)
								exports.titan_global:sendMessageToAdmins("AdmCmd: " .. tostring(adminTitle) .. " " .. getPlayerName(thePlayer) .. " gave " .. targetPlayerName .. " a motorcycle license.")
							else
								outputChatBox("Player "..targetPlayerName.." now has a "..licenseTypeOutput.." license.", thePlayer, 0, 255, 0)
							end
						elseif (licenseType == "boat") then -- BOATING LICENSE
							...
							outputChatBox("Admin "..getPlayerName(thePlayer):gsub("_"," ").." gives you a "..licenseTypeOutput.." license.", targetPlayer, 0, 255, 0)
							exports.titan_logs:dbLog(thePlayer, 4, targetPlayer, "GIVELICENSE BOAT")
							local hiddenAdmin = getElementData(thePlayer, "hiddenadmin")

							if (hiddenAdmin==0) then
								local adminTitle = exports.titan_global:getPlayerAdminTitle(thePlayer)
								exports.titan_global:sendMessageToAdmins("AdmCmd: " .. tostring(adminTitle) .. " " .. getPlayerName(thePlayer) .. " gave " .. targetPlayerName .. " a boating license.")
							else
								outputChatBox("Player "..targetPlayerName.." now has a "..licenseTypeOutput.." license.", thePlayer, 0, 255, 0)
							end
						elseif (licenseType == "fish") then -- BOATING LICENSE
							...
							outputChatBox("Admin "..getPlayerName(thePlayer):gsub("_"," ").." gives you a "..licenseTypeOutput.." license.", targetPlayer, 0, 255, 0)
							exports.titan_logs:dbLog(thePlayer, 4, targetPlayer, "GIVELICENSE FISH")
							local hiddenAdmin = getElementData(thePlayer, "hiddenadmin")

							if (hiddenAdmin==0) then
								local adminTitle = exports.titan_global:getPlayerAdminTitle(thePlayer)
								exports.titan_global:sendMessageToAdmins("AdmCmd: " .. tostring(adminTitle) .. " " .. getPlayerName(thePlayer) .. " gave " .. targetPlayerName .. " a fishing permit.")
							else
								outputChatBox("Player "..targetPlayerName.." now has a "..licenseTypeOutput.." license.", thePlayer, 0, 255, 0)
							end
...
function takePlayerLicense(thePlayer, commandName, dtargetPlayerName, licenseType)
	if exports.titan_integration:isPlayerTrialAdmin(thePlayer) then
		if not dtargetPlayerName or not (licenseType and (licenseType == "1" or licenseType == "2" or licenseType == "3" or licenseType == "4" or licenseType == "5" or licenseType == "6" or licenseType == "7")) then
			outputChatBox("* "..exports["titan_pool"]:getServerName().." Roleplay * /" .. commandName .. " [Player Nick] [Type]", thePlayer, 255, 194, 14)
			...
			local targetPlayer, targetPlayerName = exports.titan_global:findPlayerByPartialNick(nil, dtargetPlayerName)
			local username = getPlayerName(thePlayer)
				...
				elseif (logged==1) then
					...
					if getElementData(targetPlayer, "license."..licenseType) == 0 then
						...
						if (licenseType == "car") then
							exports.titan_anticheat:changeProtectedElementDataEx(targetPlayer, "license."..licenseType, 0, false)
							...
							exports.titan_logs:dbLog(thePlayer, 4, targetPlayer, "TAKELICENSE CAR")

							local hiddenAdmin = getElementData(thePlayer, "hiddenadmin")
							if (hiddenAdmin==0) then
								local adminTitle = exports.titan_global:getPlayerAdminTitle(thePlayer)
								exports.titan_global:sendMessageToAdmins("AdmCmd: " .. tostring(adminTitle) .. " " .. getPlayerName(thePlayer) .. " revoked " .. targetPlayerName .. " "..licenseTypeOutput.." license.")
							else
						...
						elseif (licenseType == "bike") then
							...
							dbExec(mysql:getConnection(), "UPDATE characters SET "..(licenseType).."_license='0' WHERE id = "..(getElementData(targetPlayer, "dbid")).." LIMIT 1")
							outputChatBox("Admin "..getPlayerName(thePlayer):gsub("_"," ").." revokes your "..licenseTypeOutput.." license.", targetPlayer, 0, 255, 0)
							exports.titan_logs:dbLog(thePlayer, 4, targetPlayer, "TAKELICENSE GUN")
						...
						elseif (licenseType == "gun2") then
							...
							dbExec(mysql:getConnection(), "UPDATE characters SET "..(licenseType).."_license='0' WHERE id = "..(getElementData(targetPlayer, "dbid")).." LIMIT 1")
							outputChatBox("Admin "..getPlayerName(thePlayer):gsub("_"," ").." revokes your "..licenseTypeOutput.." license.", targetPlayer, 0, 255, 0)
							exports.titan_logs:dbLog(thePlayer, 4, targetPlayer, "TAKELICENSE GUN2")
						...
						if rows > 0 then
							...
							if resultSet then
								...
								if (tonumber(resultSet[licenseType.."_license"]) ~= 0) then
									...
									if (resultQry) then
										exports.titan_logs:dbLog(thePlayer, 4, { "ch"..resultSet["id"] }, "TAKELICENSE "..licenseType)
										local hiddenAdmin = getElementData(thePlayer, "hiddenadmin")
										if (hiddenAdmin==0) then
											local adminTitle = exports.titan_global:getPlayerAdminTitle(thePlayer)
											exports.titan_global:sendMessageToAdmins("AdmCmd: " .. tostring(adminTitle) .. " " .. getPlayerName(thePlayer) .. " revoked " .. dtargetPlayerName .. " his ".. licenseType .." license.")
										else
