...
addEventHandler("onClientRender",getRootElement(), function ()
	if showTopRightReportBox(localPlayer) and not getElementData(localPlayer, "integration:previewPMShowing") and exports.titan_hud:isActive() then 
...
function startAutoUpdate()
	...
	elseif exports.titan_integration:isPlayerSupporter(localPlayer) then
