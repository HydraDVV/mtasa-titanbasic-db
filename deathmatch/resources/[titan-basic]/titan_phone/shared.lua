function loadFonts()
    fonts = {
        ...
        [3] = DxFont(":titan_fonts/files/RobotoL.ttf", 12),
        [4] = DxFont(":titan_fonts/files/RobotoL.ttf", 10),
        [5] = DxFont(":titan_fonts/files/RobotoL.ttf", 9),
        [6] = DxFont(":titan_fonts/files/RobotoL.ttf", 6),
        [7] = GuiFont(":titan_fonts/files/RobotoL.ttf", 10),
        [8] = DxFont(":titan_fonts/files/RobotoL.ttf", 8.4),
        [9] = DxFont(":titan_fonts/files/FontAwesome5.ttf", 10),
        [10] = DxFont(":titan_fonts/files/FontAwesome.ttf", 7),
        [11] = DxFont(":titan_fonts/files/Roboto-Regular.ttf", 10),
        [12] = DxFont(":titan_fonts/files/RobotoB.ttf", 10),
        [13] = DxFont(":titan_fonts/files/FontAwesome.ttf", 10),
...
addEventHandler("onClientResourceStart", root,
    function(startedRes)
        if getResourceName(startedRes) == "titan_fonts" then
            loadFonts()
        end
    end
)
