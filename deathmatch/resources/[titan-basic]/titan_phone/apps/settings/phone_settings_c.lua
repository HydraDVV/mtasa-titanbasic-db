...
function drawSettings(xoffset, yoffset)
    ...
    guiSetAlpha(guiCreateStaticImage(10+xoffset, 28+yoffset, 200, 1, ":titan_carshop\img\whitedot.png", false, settingGuis.main), 0.1)
    local smallLine = 16
    yoffset = yoffset + 26
...
function guiSettingClick()
	...
	elseif source == settingGuis[32] then
		if guiGetText(settingGuis[32]) == "Aktif" then
			...
			--exports.titan_ed_OwlGamingLogs:drawInfoBox()
		end
