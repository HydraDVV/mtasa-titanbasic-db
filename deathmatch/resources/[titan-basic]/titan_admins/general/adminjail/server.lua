		...
		if not (who) or not (minutes) or not (...) or (minutes<1) then
			...
			if (targetPlayer) then
				...
				if (minutes>=5000) then
					...
					minutes = "sinirsiz"
					exports.titan_anticheat:changeProtectedElementDataEx(targetPlayer, "jailtimer", true, false)
				else
					...
					exports.titan_anticheat:changeProtectedElementDataEx(targetPlayer, "jailserved", 0, false)
					exports.titan_anticheat:changeProtectedElementDataEx(targetPlayer, "jailtimer", theTimer, false)
				end
				exports.titan_anticheat:changeProtectedElementDataEx(targetPlayer, "adminjailed", true, false)
				exports.titan_anticheat:changeProtectedElementDataEx(targetPlayer, "jailreason", reason, false)
				exports.titan_anticheat:changeProtectedElementDataEx(targetPlayer, "jailtime", minutes)
				exports.titan_anticheat:changeProtectedElementDataEx(targetPlayer, "jailadmin", getPlayerName(thePlayer), false)
				
				local hiddenAdmin = getElementData(thePlayer, "hiddenadmin")

				addAdminHistory(targetPlayer, thePlayer, reason, 0 , (tonumber(minutes) and ( minutes == 5000 and 0 or minutes ) or 0))
				
				local adminTitle = exports.titan_global:getAdminTitle1(thePlayer)
				...
				if commandName == "sjail" then
					if tonumber(minutes) then
						...
						for i, v in ipairs(getElementsByType("player")) do
							if exports.titan_integration:isPlayerSeniorAdmin(v) then
								outputChatBox("(( " .. targetPlayerName .. " cezalandırıldı. Süre: " .. minutes .. " Gerekçe: ".. reason .. " - " ..string.format("%02d", saat)..":"..string.format("%02d", saniye).. " ))", v, 255, 0, 0)
							end
						end
						
						exports.titan_logs:dbLog(thePlayer, 4, targetPlayer,commandName.." for "..minutes.." mins, reason: "..reason)
					else
						exports.titan_global:sendMessageToAdmins("[HAPIS]: " .. adminTitle .. " hapise atti " .. targetPlayerName .. " isimli oyuncuyu "..minutes.." dakika.")
						exports.titan_global:sendMessageToAdmins("[HAPIS] Aciklama: " .. reason)
						exports.titan_logs:dbLog(thePlayer, 4, targetPlayer,commandName.." "..minutes..", reason: "..reason)
					end
				else
					if tonumber(minutes) then
						outputChatBox("(( " .. targetPlayerName .. " cezalandırıldı. Süre: " .. minutes .. " Gerekçe: ".. reason .. " - " ..string.format("%02d", saat)..":"..string.format("%02d", saniye).. " ))", root, 255, 0, 0)
...
function addJail(who, minutes, reason, admin, adminID)
	...
	for index, value in ipairs(exports.titan_pool:getPoolElementsByType("player")) do
    ...
    if target == nil then--isElement(target) then
            ...
            function(qh)
                ...
                if rows > 0 then
                    for index, row in ipairs(res) do
                        ...
                        exports.titan_logs:dbLog(thePlayer, 4, thePlayer, "FORUM JAIL "..accountUsername.." for "..minutes.." mins, reason: "..reason)
                    end
                else
                    return
                end
		...
		if (minutes>=5000) then
			exports.titan_anticheat:changeProtectedElementDataEx(target, "jailserved", 0, false)
			exports.titan_anticheat:changeProtectedElementDataEx(target, "jailtimer", true, false)
		else
			exports.titan_anticheat:changeProtectedElementDataEx(target, "jailtimer", theTimer, false)
			exports.titan_anticheat:changeProtectedElementDataEx(target, "adminjailed", true, false)
			exports.titan_anticheat:changeProtectedElementDataEx(target, "jailreason", reason, false)
			exports.titan_anticheat:changeProtectedElementDataEx(target, "jailtime", minutes, false)
			exports.titan_anticheat:changeProtectedElementDataEx(target, "jailadmin", admin, false)
		end
	end
                    ...
                    if rows > 0 then
                        for index, row in ipairs(res) do
                            ...
                            if commandName == "sojail" then
                                exports.titan_global:sendMessageToAdmins("[HAPIS]: " .. adminTitle .. " hapise atti " .. accountUsername .. " kullanici adli oyuncuyu " .. minutes .. " dakika.")
                                exports.titan_global:sendMessageToAdmins("[HAPIS] Aciklama: " .. reason)
                            else
                                outputChatBox("[HAPIS]: " .. adminTitle .. " hapise atti " .. accountUsername .. " kullanici adli oyuncuyu " .. minutes .. " dakika.", root, 255, 0, 0)
                                outputChatBox("[HAPIS] Aciklama: " .. reason, root, 255, 0, 0)
                            end
                            exports.titan_logs:dbLog(thePlayer, 4, thePlayer,commandName.." "..accountUsername.." for "..minutes.." mins, reason: "..reason)
                        end
                    else
...
function timerUnjailPlayer(jailedPlayer)
	if(isElement(jailedPlayer)) then
		...
		if (timeServed) then
			exports.titan_anticheat:changeProtectedElementDataEx(jailedPlayer, "jailserved", timeServed+1, false)
			local timeLeft = timeLeft - 1
			exports.titan_anticheat:changeProtectedElementDataEx(jailedPlayer, "jailtime", timeLeft, false)
			...
			if (timeLeft<=0) and not (getElementData(jailedPlayer, "pd.jailtime")) then
				...
				exports.titan_anticheat:changeProtectedElementDataEx(jailedPlayer, "jailtimer", false, false)
				exports.titan_anticheat:changeProtectedElementDataEx(jailedPlayer, "adminjailed", false, false)
				exports.titan_anticheat:changeProtectedElementDataEx(jailedPlayer, "jailreason", false, false)
				exports.titan_anticheat:changeProtectedElementDataEx(jailedPlayer, "jailtime", false, false)
				exports.titan_anticheat:changeProtectedElementDataEx(jailedPlayer, "jailadmin", false, false)
				...
				outputChatBox("#822828"..exports["titan_pool"]:getServerName()..": #ffffffHapis süreniz bitti ve hapisten başarıyla çıktınız.", jailedPlayer, 0, 255, 0, true)
				local gender = getElementData(jailedPlayer, "gender")
				local genderm = "his"
				if (gender == 1) then
					genderm = "her"
				end
				exports.titan_global:sendMessageToAdmins("[JAIL]: " .. getPlayerName(jailedPlayer):gsub("_", " ") .. " has served " .. genderm .. " jail time.")
		...
		if not (who) then
			...
			if (targetPlayer) then
				...
				if not (jailed) then
					...
					exports.titan_anticheat:changeProtectedElementDataEx(targetPlayer, "jailtimer", false, false)
					exports.titan_anticheat:changeProtectedElementDataEx(targetPlayer, "adminjailed", false, false)
					exports.titan_anticheat:changeProtectedElementDataEx(targetPlayer, "jailreason", false, false)
					exports.titan_anticheat:changeProtectedElementDataEx(targetPlayer, "jailtime", false, false)
					exports.titan_anticheat:changeProtectedElementDataEx(targetPlayer, "jailadmin", false, false)
					...
					outputChatBox("#822828"..exports["titan_pool"]:getServerName()..": #ffffff"..getElementData(thePlayer, "account:username").." isimli yetkili sizi hapisten başarıyla çıkarttı.", targetPlayer, 0, 125, 255, true)
					exports.titan_global:sendMessageToAdmins("[HAPIS]: " .. getElementData(targetPlayer, "account:username") .. " isimli oyuncu "..adminTitle.." isimli yetkili tarafindan cikartildi.")
					exports.titan_logs:dbLog(thePlayer, 4, targetPlayerName,commandName)
				end
			end
		end
	end
