function editVehicle(thePlayer, commandName)
	if exports.titan_integration:isPlayerVehicleConsultant(thePlayer) or exports.titan_integration:isPlayerSeniorAdmin(thePlayer) or exports.titan_integration:isPlayerVCTMember(thePlayer) then
		...
		exports.titan_logs:dbLog(thePlayer, 4, { theVehicle, thePlayer }, commandName)
		return true
	end
end
...
function createUniqueVehicle(data, existed)
	...
	local vehicle = exports.titan_pool:getElement("vehicle", tonumber(data.id))
	...
	if not existed then
		...
		exports.titan_logs:dbLog(client, 6, { client }, " Created unique vehicle #"..data.id..".")
		exports.titan_global:sendMessageToAdmins("[vehicle_manager]: "..getElementData(client, "account:username").." has created new unique vehicle #"..data.id..".")
		exports["titan_vehicle"]:reloadVehicle(tonumber(data.id))
		...
		exports.titan_logs:dbLog(client, 6, { client }, " Updated unique vehicle #"..data.id..".")
		exports.titan_global:sendMessageToAdmins("[vehicle_manager]: "..getElementData(client, "account:username").." has updated unique vehicle #"..data.id..".")
		exports["titan_vehicle"]:reloadVehicle(tonumber(data.id))
		return true
	end
end
...
function resetUniqueVehicle(vehID)
	...
	exports.titan_logs:dbLog(client, 6, { client }, " Removed unique vehicle #"..vehID..".")
	exports.titan_global:sendMessageToAdmins("[vehicle_manager]: "..getElementData(client, "account:username").." has removed unique vehicle #"..vehID..".")
	exports["titan_vehicle"]:reloadVehicle(tonumber(vehID))

	local vehicle = exports.titan_pool:getElement("vehicle", tonumber(vehID))
...
function openUniqueHandling(vehdbid, existed)
	if exports.titan_integration:isPlayerVehicleConsultant(client) or exports.titan_integration:isPlayerSeniorAdmin(client) then
