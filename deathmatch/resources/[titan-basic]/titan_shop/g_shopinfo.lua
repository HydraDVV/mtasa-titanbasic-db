...
function loadLanguages( )
	...
	for i = 1, exports['titan_languages']:getLanguageCount() do
		local ln = exports['titan_languages']:getLanguageName(i)
		if ln then
	...
	elseif shop_type == 14 then
		...
		for v = 1000, 1193 do
			if vehicle_upgrades[v-999] then
				local str = exports['titan_items']:getItemDescription( 114, v )
