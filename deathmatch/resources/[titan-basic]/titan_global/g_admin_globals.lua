function getAdminTitles()
	return exports.titan_integration:getAdminTitles()
end
...
function getPlayerAdminTitle(thePlayer)
	if isElement(thePlayer) then
		if exports.titan_integration:isPlayerIA( thePlayer ) then
		...
		if exports.titan_integration:isPlayerTrialAdmin(thePlayer) then
			...
			return text
		elseif exports.titan_integration:isPlayerSupporter(thePlayer) then
			return "Rehber"
		elseif exports.titan_integration:isPlayerLeadScripter(thePlayer) then
			return "Scripter"
		elseif exports.titan_integration:isPlayerScripter(thePlayer) then
			return "Trial Scripter"
		elseif exports.titan_integration:isPlayerVCTMember(thePlayer) then
			return "Vehicle Consultation Member"
		elseif exports.titan_integration:isPlayerVehicleConsultant(thePlayer) then
			return "Vehicle Consultation Leader"
		elseif exports.titan_integration:isPlayerMappingTeamMember(thePlayer) then
			return "Mapper"
		else
			return "Player"
		end
...
function isPlayerLvl2Scripter(thePlayer)
	return lvl2scripters[thePlayer] or lvl2scripters[ getElementData(thePlayer, "account:username") or "Hanz" ] or false
end

function isPlayerIA(thePlayer)
	return internalaffairs[thePlayer] or internalaffairs[ getElementData(thePlayer, "account:username") or "Hanz" ] or false
end

function isPlayerScripter(thePlayer)
	return exports["titan_integration"]:isPlayerScripter(thePlayer)
end
...
function isStaff(thePlayer)
	if thePlayer and isElement(thePlayer) and getElementType(thePlayer) == "player" then
		return exports.titan_integration:isPlayerTrialAdmin(thePlayer) or exports.titan_integration:isPlayerSupporter(thePlayer)
	else
		return false
	end
end
...
function isAdminOnDuty(thePlayer)
	if thePlayer and isElement(thePlayer) and getElementType(thePlayer) == "player" then
		return exports.titan_integration:isPlayerTrialAdmin(thePlayer) and (getElementData(thePlayer, "duty_admin") == 1)
	else
		return false
	end
end
...
function isSupporterOnDuty(thePlayer)
	if thePlayer and isElement(thePlayer) and getElementType(thePlayer) == "player" then
		return exports.titan_integration:isPlayerSupporter(thePlayer) and (getElementData(thePlayer, "duty_supporter") == 1)
	else
		return false
	end
end
