function birlikKurGUI()
	...
	birlikWindow = guiCreateWindow((screenW - 288) / 2, (screenH - 321) / 2, 288, 321, ""..exports["titan_pool"]:getServerName().." Roleplay - Birlik Sistemi", false)
...
function birlikSeviyeGUI(birlikIsmi, birlikLevel)
	...
	seviyeWindow = guiCreateWindow((screenW - 289) / 2, (screenH - 181) / 2, 289, 230, ""..exports["titan_pool"]:getServerName().." Roleplay- - Birlik Seviyesi ", false)
...
function adminBirlikKur()
	guiSetInputMode("no_binds_when_editing")
	local screenW, screenH = guiGetScreenSize()
	adminBirlikWindow = guiCreateWindow((screenW - 288) / 2, (screenH - 321) / 2, 288, 321, ""..exports["titan_pool"]:getServerName().." Roleplay - Birlik Oluştur", false)
